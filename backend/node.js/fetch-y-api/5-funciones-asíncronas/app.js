...
//  Ventajas 
// - El flujo de arriba hacia abajo es más natural que con .then().
// - Se ven claros los pasos: pedir → validar → convertir → usar → manejar error.
// - Menos indentación y anidación.